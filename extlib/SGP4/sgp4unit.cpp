       ...
       if (inclp >= 0.2)
         ...
         else
         {
           ...
           if (fabs(xnoh - nodep) > pi)
               {
               if (nodep < xnoh) nodep = nodep + twopi;
               else nodep = nodep - twopi;
               }
           mp    = mp + pl;
     ...
     )
{
     ...
     double ainv2 , aonv=0.0, cosisq, eoc, f220 , f221  , f311  ,
          ...
          root52, x2o3  , xke = 0.0    , znl   , emo   , zns   , emsqo,
...
{
     /* --------------------- local variables ------------------------ */
     double ak, d1, del, adel, po, x2o3, j2 = 0.0, xke = 0.0,
     ...
     )
{
     ...
     double ao, ainv,   con42, cosio, sinio, cosio2, eccsq,
          ...
          tumin, mu, radiusearthkm = 0.0, xke, j3, delmotemp, qzms2ttemp, qzms24temp;
     ...
     )
{
     double am   , axnl  , aynl , betal ,  cosim , cnod  ,
         ...
         twopi, x2o3  , j2 = 0.0  , j3    , tumin, j4 , xke = 0.0   , j3oj2 = 0.0, radiusearthkm = 0.0,
