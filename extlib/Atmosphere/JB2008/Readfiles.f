...
!C
!      INPFILE  = 'Data/JB2008_AUTO_INPUT.TXT'
!      OUTFILE  = 'Data/JB2008_AUTO_OUTPUT.TXT'
!C
...
C***********************************************************************
C
      SUBROUTINE DTCVAL (T1950,IDTCVAL,FDTC,FGAP)
C
...
C
      ...
      KGUNIT = 47
C
      !FDTC = 'data/atmosphere/JB2008/DTCFILE.TXT'
      !FGAP = 'data/atmosphere/JB2008/DSTFILE.TXT'
C
      IF (IDTCRD.NE.1) THEN
C
...
C
      ...
      !WRITE(*,'(A,D8.3)') 'T1950 = ', T1950
      !WRITE(*,'(A,I8)') 'IDTCVAL = ', IDTCVAL
C
   50 RETURN
...
C     FLUXUNIT = 'SOLFSMY.DAT'          Deprecated
      !FLUXUNIT = 'data/atmosphere/JB2008/SOLFSMY.TXT'
C
