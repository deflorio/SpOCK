...
C      Put identification data into common/datime/
    ...
    2 CONTINUE
      !WRITE(*,'(A,I8)') 'IYD = ', IYD
      !WRITE(*,'(A,E8.3)') 'SEC = ', SEC
      !WRITE(*,'(A,F8.3)') 'ALT = ', ALT
      !WRITE(*,'(A,F8.3)') 'GLAT = ', GLAT
      !WRITE(*,'(A,F8.3)') 'GLONG = ', GLONG
      !WRITE(*,'(A,F8.3)') 'STL = ', STL
      !WRITE(*,'(A,F8.3)') 'F107A = ', F107A
      !WRITE(*,'(A,F8.3)') 'F107 = ', F107
      !WRITE(*,'(A,F8.3)') 'AP(1) = ', AP(1)
      !WRITE(*,'(A,F8.3)') 'AP(2) = ', AP(2)
      !WRITE(*,'(A,F8.3)') 'AP(3) = ', AP(3)
      !WRITE(*,'(A,F8.3)') 'AP(4) = ', AP(4)
      !WRITE(*,'(A,F8.3)') 'AP(5) = ', AP(5)
      !WRITE(*,'(A,F8.3)') 'AP(6) = ', AP(6)
      !WRITE(*,'(A,F8.3)') 'AP(7) = ', AP(7)
      !WRITE(*,'(A,I8)') 'MASS = ', MASS
C
