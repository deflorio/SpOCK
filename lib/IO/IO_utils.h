...
void RunStartMessage(Vector6d init_orbtime, Vector6d init_orbstate, double SIM_STEP, int SIM_DURATION, bool* T_model, int nMAX, string ODEINT_stepper, double* ODEINT_params, string Drag_Model, string SRP_Model, string magneticfield, string gravityfield, string atmosphere, string sunmoon, string proptype);
